...
export default function PractiseLogin(){ 
  ...
  async function handleLogin(event){
    ...
    try {     
     const response=""; axios.post('http://localhost:8080/api/Company/auth',data).then((response)=>{
    ...
    <section className="col-lg-7 col-md-10 mx-auto d-block pt-5">
        <div className="container">
             <div className="row">
                 ...
                 <form onSubmit={handleLogin} >
                         <div className="float-end pb-5">Wants to Hire? <a href="/company-register">SignUP</a>  </div>
