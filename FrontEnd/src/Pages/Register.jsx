    ...
    return(
        ...
        <div className="container">
            <div className="row">
                ...
                <div><h3 className="fw-bold">CSP</h3>
                <h5 className="px-5">You are just few clicks away from Creating your Career Service Portal Account</h5>
                </div>
                ...
                <form>                       
                        ...
                        <div className="col-8">
                        <div className="material-textfield mb-2"> 
                        <input className="input form-control"  placeholder=" " type="text" /><label className="label" required>Current Address</label>
                        </div>
                        </div>
                        ...
                        <div className="col-4">
                        <div className="material-textfield mb-2"> 
                        <input className="input form-control"  placeholder=" " type="text"  value={role} onChange={(e)=>setRole(e.target.value)}/><label className="label" required>Role</label>
                        </div>
                        </div>
                        ...
                        <div className="material-textfield mb-2">                    
                           <input className="input form-control"  placeholder=" " type="text" /><label className="label" required>City</label>
                        </div>                       
                        </div>                      
                        ...
                        <div className="material-textfield mb-2">                    
                           <input className="input form-control"  placeholder=" " type="text" /><label className="label" required>Pincode</label>
                        </div>  
                        </div>
                        <div className="col-sm-6">
                        <div className="material-textfield mb-2">                    
                           <input className="input form-control" type="password" id="InputPwd" placeholder=" "    value={password}  onChange={(e)=>setPassword(e.target.value)} required/><label className="label">Password</label>                          
                        </div> 
                        </div>
                        <div className="col-sm-6 ">
                        <div className="material-textfield mb-2">                    
                           <input className="input form-control"  type="password" id="confirmPwd" placeholder=" " required/><label className="label">Confirm Password</label>
                        </div>                                                 
                        </div>
                        <div className="col-sm-12"> <input type="checkbox" id="togglePassword"  /><label htmlFor="togglePassword"> &nbsp;&nbsp; Show/Hide password</label></div>
                    </div>
