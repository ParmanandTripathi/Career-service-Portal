          ...
          <div className='col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-light'>
            <div className='d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100'>
              ...
              <a href='/' className='d-flex align-items-center pb-3 mb-md-0 me-md-auto text-decoration-none'>
                <span className='fs-5 d-none d-sm-inline'>Hello  </span>
              </a>
              <ul className='nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start' id='menu'>                
                ...
                <li>
                  <a href='/Admin/dashboard/company-verify' className='nav-link px-0 align-middle pb-4' >
                    <i className='fa-solid fa-table'></i>
                    <span className='ms-2 d-none d-sm-inline'> Companies Varification</span></a>
                </li>
                <li>
                  <a href='/Admin/dashboard/company-delete' className='nav-link px-0 align-middle pb-4' >
                    <i className='fa-solid fa-table'></i>
                    <span className='ms-2 d-none d-sm-inline'>Delete Company Acc</span></a>
                </li>
