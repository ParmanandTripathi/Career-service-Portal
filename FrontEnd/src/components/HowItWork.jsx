    ...
    <>
      <section className='p-5 text-center mb-4'>
        <section className='text-center'>
          <h2>How It Works ?</h2>
          <p>
            Getting your Dream job is just few clicks away. Create your Free
            Account Now
          ...
          <div className='row'>
            <div className='col-lg-4 col-md-12 mb-4'>
              ...
              <p>
                Go to The <a href='/login'>Login Page</a>, if You Already Have a
            ...
            <div className='col-lg-4 col-md-6 mb-4'>
              ...
              <p>
                ...
                on Our Platform. Search your Dream Job and just click Apply.
              </p>
            </div>
            <div className='col-lg-4 col-md-6 mb-4'>
              <img
              ...
              <h4>Apply</h4>
              <p>
                Search your Dream Job and just click Apply. Check your Dashboard
                and Email for Acceptance and any Further Details Required by job
                Provider.
              </p>
            </div>
          </div>
