          ...
          <div className='col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-light'>
            <div className='d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white '>
              ...
              <ul className='nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start' id='menu'>
                <li>
                  <a
                    href='/user/dashboard' className='nav-link px-0 align-middle pb-4'>
                ...
                <li>
                  <a
                    href='/user/dashboard/delete-user'
                ...
                <li>
                  <a href='/user/dashboard/search-job' className='nav-link px-0 align-middle pb-4'>
                ...
                <li>
                  <a href='/user/dashboard/check-response' className='nav-link px-0 align-middle pb-4'>
                    <i className='fa-brands fa-bootstrap'></i>
                    <span className='ms-2 d-none d-sm-inline'>Check Response</span>
                  </a>
                </li>

                
                <li>
                  <a href='/user/dashboard/change-password' className='nav-link px-0 align-middle pb-4'>
                    <i className='fa-brands fa-bootstrap'></i>
                    <span className='ms-2 d-none d-sm-inline'>Change Password</span>
                  </a>
                </li>
                <li>
                  <a href='/user/dashboard/addQualification' className='nav-link px-0 align-middle pb-4'>
                    <i className='fa-brands fa-product-hunt'></i>
                    <span className='ms-2 d-none d-sm-inline'>Add Qualification</span>
                  </a>
                </li>
                <li>
                  <a href='/user/dashboard/signout' className='nav-link px-0 align-middle pb-4' onClick={handleLogout}>
